...
class GameRepositoryController implements IGameRepository {
  final IHttpClient client;

  GameRepositoryController({required this.client});
  ...
  Future<List<GameModel>> getGames(String sorting) async {
    try {
      final response = await client.get(
          url: 'https://www.freetogame.com/api/games?sort-by=$sorting');
  ...
  Future<List<GameModel>> getGamesGenres(String sorting) async {
    try {
      final response = await client.get(
          url: 'https://www.freetogame.com/api/games?category=$sorting');
